...
- Verify API key is configured in settings (⚙ button)
- Check that a model is selected
- Use "Test API Key" button to verify credentials
- Check browser console (F12) for error messages
- Ensure internet connectivity

**Find conflicts?**
- This extension replaces Chrome's default Ctrl+F
- Temporarily disable to use native find functionality
